...
Note:
- the free software movement is lead by Free Software Foundation (FSF)
- founded by Richard Stallman (known for GNU, gcc, etc.) in 1985
...
Note:
- no restricted EULA
- redistribution of the software is according to the license under which it is distributed
- permissive licenses allow you to do whatever you want with the software
  - copy left licenses requires your source code to be open sourced as well
...
Note:
- having the freedom of looking at the source code
- keeping a copy and/or consult someone with the know-how
...
Note:
- if you are a contributor to an open source project, it is understood that you are familiar with the ways of the software industry and the effort to train you will be less. this is a plus in interviews.
- if you identify and fix a security issue, you are helping the world be a better and safer place
